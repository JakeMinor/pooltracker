...
export default {
    root: ({ props, context, parent } : ButtonPassThroughMethodOptions<any>) => ({
        class: [
            'relative',
    ...
    icon: ({ props } : ButtonPassThroughMethodOptions<any>) => ({
        class: [
            'mx-0',
            {
    ...
    loadingicon: ({ props } : ButtonPassThroughMethodOptions<any>) => ({
        class: [
            'h-3 w-3',
            'mx-0',
            {
